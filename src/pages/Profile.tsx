...
const Profile = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-4"> {/* Reduced py-8 to py-4 */}
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="max-w-xl mx-auto" // Changed from max-w-2xl to max-w-xl
      >
        {/* Hero Section - Further reduced height */}
        <div className="relative h-32 md:h-40 rounded-t-2xl overflow-hidden"> {/* Reduced from h-40 md:h-48 */}
          {/* Animated Background */}
        ...
        <div className="bg-gradient-to-br from-purple-900/90 to-black/90 rounded-b-2xl p-4 pt-4 
          backdrop-blur-xl border border-white/10 shadow-xl space-y-4"> {/* Changed pt-6 to pt-4 */}
